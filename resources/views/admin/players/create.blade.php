...
<div class="card">
   <div class="card-header">
      {{ trans('global.create') }} {{ trans('global.player.title_singular') }}
   </div>
   <div class="card-body">
      <form action="{{route("admin.players.store")}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="form-group {{ $errors->has('team_id') ? 'has-error' : '' }}">
         <label for="team_id">{{ trans('global.team.title_singular') }}*</label>
      ...
      <div class="form-group {{ $errors->has('country_id') ? 'has-error' : '' }}">
         <label for="country_id">{{ trans('global.player.fields.country') }}*</label>
