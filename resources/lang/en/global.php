...
return [
    ...
    'site_title'                           => 'Cricket Application',
    'userManagement'                       => [
    ...
    'player'                              => [
        ...
        'player_history' => 'Player Career History',
        'fields'         => [
            'id'                 => 'ID',
            'image'              => 'Photo',
            'lastname'           => 'Last Name',
            'firstname'          => 'First Name',
            'jerseyNo'           => 'Jersey Number',
            'country'            => 'Country',
            'matches'            => 'Matches',
            'runs'               => 'Total Runs',
    ...
    'team'                              => [
        'title'          => 'Teams',
        'title_singular' => 'Team',
        'title_players'  => 'Players in this Team',
        'title_player_history'  => 'Player Career History',
        'fields'         => [
            'id'                 => 'Team ID',
            'name'               => 'Name',
            'logo'               => 'Logo',
    ...
    'match'                              => [
        ...
        'title_fixtures' => 'Generate Match Fixtures Between Teams',
        'fields'         => [
            'id'                 => 'Team ID',
            'match_title'        => 'Match/Series Title',
            'firstteam_id'      => 'First Team',
            'secondteam_id'     => 'Second Team',
            'winningteam_id'    => 'Winning Team',
            'deleted_at'         => 'Deleted at',
        ],
    ],
    'point'              => [
        'title'          => 'Points',
        'title_singular' => 'Points scored by Teams',
        'fields'         => [
            'id'         => 'Team ID',
            'team'       => 'Team',
            'points'     => 'Points',
